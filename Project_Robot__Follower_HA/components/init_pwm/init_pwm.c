...
esp_err_t init_pwm(void)
{
    ...
    ConfigTimer1PWM.duty_resolution = LEDC_TIMER_12_BIT;
    ...
    ConfigTimer2PWM.duty_resolution = LEDC_TIMER_12_BIT;
    ...
    ESP_LOGI(tag, "salidas pwm inicializadas");
...
void set_pwm(char chanel, uint16_t duty)
{
    ...
    ledc_set_duty(LEDC_HIGH_SPEED_MODE, chanel, duty);
    ledc_update_duty(LEDC_HIGH_SPEED_MODE, chanel);
