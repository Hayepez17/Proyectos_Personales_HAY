...
esp_err_t init_pwm(void)
{
    ...
    ConfigTimer1PWM.duty_resolution = LEDC_TIMER_8_BIT;
    ConfigTimer1PWM.timer_num = LEDC_TIMER_1;
    ConfigTimer1PWM.freq_hz = 80000;
    ...
    ConfigTimer2PWM.duty_resolution = LEDC_TIMER_8_BIT;
    ConfigTimer2PWM.timer_num = LEDC_TIMER_2;
    ConfigTimer2PWM.freq_hz = 80000;
...
void set_pwm(uint16_t duty1, uint16_t duty2)
{
    ...
    vTaskDelay(200 / portTICK_PERIOD_US);
