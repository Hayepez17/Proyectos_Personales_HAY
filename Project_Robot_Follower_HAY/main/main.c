...
#define EXAMPLE_DEVICE_NAME "ROBOT_MOVIL_HY_BT"
#define SPP_SHOW_DATA 0
#define SPP_SHOW_SPEED 1
#define SPP_SHOW_MODE SPP_SHOW_DATA /*Choose show mode: show data or speed*/

#define VelocidadM1 3000
#define VelocidadM2 3000

bool x1 = 0, x2 = 0, x3 = 0, x4 = 0;

uint16_t DutyM1 = 0, DutyM2 = 0;
        ...
        for (size_t i = 0; i < (param->data_ind.len) - 2; i++)
        {
            ...
            case 'F':
                if (x1 == 0)
                {
                    ...
                    set_pwm(LEDC_CHANNEL_1, DutyM1);
                    set_pwm(LEDC_CHANNEL_2, DutyM2);
                }
